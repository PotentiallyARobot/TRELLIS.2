    ...
    def from_pretrained(cls, path: str, config_file: str = "pipeline.json") -> "Pipeline":
        ...
        for k, v in args['models'].items():
            ...
            try:
                ...
                # Only try bare v if path looks like a HF repo (contains /)
                # and the local path doesn't have .json/.safetensors files
                if "/" in path and not os.path.exists(f"{local_model_path}.json"):
